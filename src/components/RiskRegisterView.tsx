    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-3xl font-black text-zinc-900 dark:text-zinc-100 tracking-tight uppercase italic">Risk Register</h2>
            <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest mt-1">Identify • Assess • Mitigate</p>
          </div>
        </div>
        <button
          onClick={addRow}
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-zinc-50/50 dark:bg-zinc-900/50 border-b border-zinc-200 dark:border-zinc-800">
                <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500">Risk Description</th>
                ...
                <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500">Mitigation Strategy</th>
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-20 text-center">
                      <div className="flex flex-col items-center gap-4 text-zinc-400">
                        ...
                        <p className="text-sm font-medium">No risks identified yet. Click "Add Risk" to start.</p>
                      </div>
                    </td>
                  </tr>
                ) : (
                    ...
                    >
                      <td className="px-6 py-4">
                        <textarea
                          ...
                          placeholder="Potential threat or issue..."
                      ...
                      <td className="px-6 py-4">
                        <textarea
                          ...
                          placeholder="How will you handle this?"
                          className="w-full bg-transparent border-none outline-none resize-none text-sm font-medium text-zinc-600 dark:text-zinc-400 placeholder:text-zinc-300 dark:placeholder:text-zinc-800 italic"
                          rows={2}
                        />
                      </td>
      ...
      <div className="bg-rose-50 dark:bg-rose-900/10 border border-rose-100 dark:border-rose-900/20 rounded-3xl p-6">
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="text-sm font-bold text-rose-900 dark:text-rose-100 uppercase tracking-tight">Proactive Resilience</h4>
            <p className="text-xs text-rose-700 dark:text-rose-400 mt-1 leading-relaxed">
              Identifying high-probability, high-impact risks early allows you to build a more resilient strategy. Use the **AI Strategist** to help identify common industry risks you might have missed.
            </p>
          </div>
        </div>
      </div>
