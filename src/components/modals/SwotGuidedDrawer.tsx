                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2 relative">
                      ...
                      <textarea
                        ...
                        className="w-full h-40 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 text-sm text-zinc-800 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-blue-500/40 resize-none leading-relaxed"
