...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-72 bg-white dark:bg-zinc-950 border-r border-zinc-100 dark:border-zinc-800 flex flex-col h-screen transition-transform duration-300 md:sticky md:translate-x-0 ${
        ...
        <div className="p-8 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="p-2 text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100 md:hidden rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors"
            title="Close Menu"
          >
            <X className="w-5 h-5" />
          </button>
          ...
          <div className="p-8 pb-4 pt-2">
            <nav className="space-y-1">
              ...
              <motion.button 
                whileHover={{ x: 4 }}
                whileTap={{ scale: 0.98 }}
                onClick={() => { navigate('/strategy-map'); onClose?.(); }}
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-bold tracking-tight text-sm ${
              ...
              <motion.button 
                whileHover={{ x: 4 }}
                whileTap={{ scale: 0.98 }}
                onClick={() => { navigate('/mission-vision'); onClose?.(); }}
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-bold tracking-tight text-sm ${
              ...
              <motion.button 
                whileHover={{ x: 4 }}
                whileTap={{ scale: 0.98 }}
                onClick={() => { navigate('/pestel'); onClose?.(); }}
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all font-bold tracking-tight text-sm ${
                  currentView === 'pestel' 
                    ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 shadow-sm' 
                    : 'text-zinc-500 hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:text-zinc-900 dark:hover:text-zinc-100'
                      ...
                      {isMoreModelsOpen && (
                        ...
                        >
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/porter'); onClose?.(); }}
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/lean-canvas'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/ansoff'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/value-chain'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/customer-journey'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/risk-register'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
              ...
              {(() => {
                const planViews = ['executive-summary', 'mission-vision', 'financials', 'business-details'];
                  ...
                  <div className="mt-2">
                    ...
                    <AnimatePresence>
                      {isBusinessPlanOpen && (
                        ...
                        >
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/business-details'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                              currentView === 'business-details' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 shadow-sm' : 'text-zinc-500 hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:text-zinc-900 dark:hover:text-zinc-100'
                            }`}
                          >
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/executive-summary'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/business-products'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/business-market'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/business-competitors'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                              currentView === 'strategic-policy' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 shadow-sm' : 'text-zinc-500 hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:text-zinc-900 dark:hover:text-zinc-100'
                            }`}
                          >
                            <Shield className="w-4 h-4" />
                            Strategic Policies
                          ...
                          <motion.button whileHover={{ x: 4 }} whileTap={{ scale: 0.98 }}
                            onClick={() => { navigate('/financials'); onClose?.(); }}
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all font-bold tracking-tight text-sm ${
                          ...
                          <div className="pt-2 mt-2 border-t border-zinc-100 dark:border-zinc-800/60">
                            <motion.button 
                              ...
                              whileTap={{ scale: 0.98 }}
                              onClick={() => { handleExportReport?.(); onClose?.(); }}
              ...
              {(userProfile?.isPaidTier || userProfile?.email === 'david.young@reallysimpleapps.com') && (
                <div className="pt-4 mt-4 border-t border-zinc-100 dark:border-zinc-800">
                  <motion.button 
                    whileHover={{ x: 4 }}
                    whileTap={{ scale: 0.98 }}
                    onClick={() => { (window as any).toggleAIConsultant?.(); onClose?.(); }}
